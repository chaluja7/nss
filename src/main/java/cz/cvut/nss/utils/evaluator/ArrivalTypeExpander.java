...
//        LocalDateTime startNodeArrivalDateTime = new LocalDateTime(arrivalDateTime);
//        if(arrivalMillisOfDay < currentNodeTimeProperty) {
//            //prehoupl jsem se pres pulnoc
//            startNodeArrivalDateTime = startNodeArrivalDateTime.minusDays(1);
//        }
//
//        startNodeArrivalDateTime = startNodeArrivalDateTime.millisOfDay().withMinimumValue();
//        startNodeArrivalDateTime = startNodeArrivalDateTime.plusMillis(currentNodeTimeProperty.intValue());
//        long startNodeMillisTime = startNodeArrivalDateTime.toDateTime().getMillis();
//        //startNodeArrivalDateTime nyni obsahuje datum i cas prijezdu currentNodu
//        //startNodeMillisTime obsahuje jen cas prijezdu (v millis od pulnoci) currentNodu
//
//        //Jsem na prvnim NODu
