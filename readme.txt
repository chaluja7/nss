...
1. Databáze PostgreSQL
    ...
    b) Stáhněte a nainstalujte si aplikaci pgAdmin (volitelné).
    Odkaz na stažení: http://www.pgadmin.org/download/

    c) V aplikaci pgAdmin (nebo dle Vašich zvyklostí) vytvořte na svém lokálním databázovém (PostgreSQL) serveru databázi "nss".
...
3. Aplikační server WildFly
    ...
    a) Stáhněte a nainstalujte si aplikační server WildFly 8 (aplikace testována pro verzi 8.1).
...
5. Spuštění aplikace
    ...
    c) Příkazem "mvn clean install" nainstalujte aplikaci do lokálního repozitáře, tímto také dojde ke stažení všech maven závislostí. Současně se provede řada integračních a jednotkových testů.
    ...
    e) Po spuštění serveru bude aplikace dostupná na "localhost:8080/NSS/" (při defaultním nastavení).
